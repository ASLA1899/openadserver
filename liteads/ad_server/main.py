...
from liteads.ad_server.routers import ad, event, health, media
...
def create_app() -> FastAPI:
    ...
    app.include_router(event.router, prefix="/api/v1/px", tags=["pixel"])
    app.include_router(media.router, prefix="/res", tags=["media"])
